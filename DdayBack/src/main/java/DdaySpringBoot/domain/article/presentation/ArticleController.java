...
public class ArticleController {
    ...
    public ResponseEntity<ApiResponse<List<ArticleResponse>>> findAllArticles(
        ...
        if (articleType != null && !articleType.isEmpty() && topic != null && !topic.isEmpty()) {
            ...
            articles = articleService.findByTopic(topic);
        } else {
